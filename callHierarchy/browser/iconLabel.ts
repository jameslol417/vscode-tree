...
export class IconLabel extends Disposable {
	...
	private descriptionNode: FastLabelNode | undefined;
	...
	private setupHover(htmlElement: HTMLElement, tooltip: string | undefined): void {
		...
		if (this.hoverDelegate.showNativeHover) {
			function setupNativeHover(htmlElement: HTMLElement, tooltip: string | undefined): void {
